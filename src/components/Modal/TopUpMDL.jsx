        ...
        {subscription.map((item) => (
          <div key={item.id} className="flex justify-center items-center m-2">
            <input
              ...
              onChange={() => setSelectSubscription(item)}
              className="hidden peer"
            />
            <label
              htmlFor={`subscription-${item.id}`}
              className="flex flex-col p-4 w-[156px] h-[102px] bg-gradient-to-r from-[#EF232813] to-[#FB942B13] text-left rounded-lg border-2 peer-checked:border-[#EF232840] border-[#FB942B40]"
            >
