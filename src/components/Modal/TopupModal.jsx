      ...
      html: `
                    <div class="w-full bg-white rounded-lg rounded-br-none z-50 h-full flex flex-col gap-5">
                        ...
                        <div class="flex gap-5 flex-row">
                          ${[...Array(2)]
                            .map(
                              (_, index) =>
                                `
                                    <div key=${index} class="flex flex-col bg-[#fcf4ef] w-[50%] h-[130px] gap-2 items-start justify-center p-5 border-2 border-[#f9dec2] rounded-[16px]">
                                    <p class="text-black font-bold">10 Menit</p>
                                    <p class="text-[#ED0226] font-bold">Rp5.000</p>
                                    </div>
                                `
                            )
                            .join("")}
                        ...
                        <div class="flex gap-5 flex-row">
                          ${[...Array(1)]
                            .map(
                              (_, index) =>
                                `
                                    <div key=${index} class="flex flex-col bg-[#f9e5d9] w-[50%] h-[130px] gap-1 items-start justify-start border-[3px] border-[#eb8f42] rounded-[16px] px-5">
                                        ...
                                        <div class="flex flex-row gap-2 items-center justify-start">
                                            ...
                                            <div class="flex flex-col items-start">
                                                <p class="text-[#ED0226] font-bold">Rp5.000</p>
                                                <p class="text-[#9CA9B9] line-through text-sm">Rp10.000</p>
                                            </div>
                                        </div>
                                    </div>
                                `
                          ...
                          ${[...Array(1)]
                            .map(
                              (_, index) =>
                                `
                                    <div key=${index} class="flex flex-col bg-[#fcf4ef] w-[50%] h-[130px] gap-1 items-start justify-start border-[2px] border-[#f9dec2] rounded-[16px] px-5">
                                        <p class="bg-gradient-to-t from-[#EF2328] to-[#FB942B] text-white px-2 py-1 flex text-center text-[13px] rounded-b-xl">Promo<p/>
                        ...
                        <button 
                            disabled
                            type="submit" 
                            class="disabled:bg-slate-500 w-full bg-gradient-to-t from-[#EF2328] to-[#FB942B] text-white py-2 rounded-[100px] hover:bg-blue-700 focus:outline-none h-[50px]"
                        >
                            Beli
                        </button>
                    </div>
