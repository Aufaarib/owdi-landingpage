    ...
    return (
        <div className="relative">
            ...
            <div style={{
                ...
                >
                    Mulai Sesi Ngobrol
                    <img src="/img/union.png" alt="" style={{
                        position: 'absolute',
                        width: '58px',
                        height: '46px',
                        right: '10px',
                        ...
                        >
                            ...
                            <div className="p-2">
                                <p className="text-[12px] text-[#001A41] line-clamp-3 overflow-hidden text-ellipsis">
                                    ...
                                    labore distinctio voluptates voluptatum eos veniam autem, modi
                                    impedit deleniti quae repellendus omnis, libero excepturi, reiciendis
                                    totam nihil magni facilis cum?
                                </p>
                            </div>
                        </div>
                    ))}
